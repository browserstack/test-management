...
const EDIT_TESTCASE_DESCRIPTION_DETAILS = "<p>Edit Test Case with Description</p>"

const CREATE_TESTCASE_TEXT_STEPS_RESULTS_NAME = "Test Case with Template as Text and Steps, Results defined"
const CREATE_TESTCASE_TEXT_STEPS = "[\"<div>\\n<div>Test Case with Steps</div>\\n</div>\"]"
const CREATE_TESTCASE_TEXT_RESULTS = "<div>\n<div>Test Case with Results</div>\n</div>"
const EDIT_TESTCASE_TEXT_STEPS = "[\"<div>\\n<div>Edit Test Case with Steps</div>\\n</div>\"]"
const EDIT_TESTCASE_TEXT_RESULTS = "<div>\n<div>Edit Test Case with Results</div>\n</div>"

const CREATE_TESTCASE_STEPS_NAME = "Test Case with Template as Steps"
const CREATE_TESTCASE_STEPS = "[{\"step\":\"<p>Test Case with Step 1</p>\",\"expected_result\":\"<p>Test Case with Result 1</p>\"},{\"step\":\"<p>Test Case with Step 2</p>\",\"expected_result\":\"<p>Test Case with Result 2</p>\"},{\"step\":\"<p>Test Case with Step 3</p>\",\"expected_result\":\"<p>Test Case with Result 3</p>\"}]"
const EDIT_TESTCASE_STEPS = "[{\"step\":\"<p>Edit Test Case with Step 1</p>\",\"expected_result\":\"<p>Edit Test Case with Result 1</p>\"},{\"step\":\"<p>Edit Test Case with Step 2</p>\",\"expected_result\":\"<p>Edit Test Case with Result 2</p>\"},{\"step\":\"<p>Edit Test Case with Step 3</p>\",\"expected_result\":\"<p>Edit Test Case with Result 3</p>\"}]"
...
const CREATE_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS = "<div>\n<div>Test Case with Precondition</div>\n</div>"
const EDIT_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS = "<div>\n<div>Edit Test Case with Precondition</div>\n</div>"
...
let testcaseConstant = {
  ...
  EDIT_TESTCASE: "/api/v1/projects/:project_id/folder/:folder_id/test-cases/:testcase_id/edit",
  DELETE_TESTCASE: "/api/v1/projects/:project_id/folder/:folder_id/test-cases/:testcase_id/delete",
  ...
  CREATE_TESTCASE_TEXT_STEPS_RESULTS_NAME: CREATE_TESTCASE_TEXT_STEPS_RESULTS_NAME,
  ...
  CREATE_TESTCASE_SHOW_MORE_FIELDS_TYPE_OF_TC: CREATE_TESTCASE_SHOW_MORE_FIELDS_TYPE_OF_TC,
  EDIT_TESTCASE_SHOW_MORE_FIELDS_TYPE_OF_TC: EDIT_TESTCASE_SHOW_MORE_FIELDS_TYPE_OF_TC,
  CREATE_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS: CREATE_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS,
  EDIT_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS: EDIT_TESTCASE_SHOW_MORE_FIELDS_PRECONDITIONS,
  CREATE_TESTCASE_SHOW_MORE_FIELDS_PRIORITY: CREATE_TESTCASE_SHOW_MORE_FIELDS_PRIORITY,
  EDIT_TESTCASE_SHOW_MORE_FIELDS_PRIORITY: EDIT_TESTCASE_SHOW_MORE_FIELDS_PRIORITY,
  CREATE_TESTCASE_SHOW_MORE_FIELDS_STATE: CREATE_TESTCASE_SHOW_MORE_FIELDS_STATE,
